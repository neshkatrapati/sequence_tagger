...
class RNNModel(nn.Module):
    ...
    def __init__(self, rnn_type, ntoken, nclasses, ninp, nhid, nlayers, corpus, dropout=0.5, tie_weights=False):
        ...
        self.decoder = nn.Linear(nhid*2, nclasses) # Hidden Layer -> Classes Softmax
        ...
        # Cannot tie weights here. This aint word-embeddings
